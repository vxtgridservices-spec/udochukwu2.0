...
import { Download, Sparkles, CheckCircle, FileText, Check, Mail, Heart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-slate-900 dark:text-white mt-4 font-normal tracking-tight">
            Free Masterclass Checklists & Templates
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {resources.map((r, rIdx) => (
            <div
              key={r.id}
              className="bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-xs hover:shadow-md transition-all relative overflow-hidden group hover:border-blue-500"
            >
              {/* Type Badge */}
              <div className="absolute top-0 right-0 bg-blue-500 text-white text-[9px] font-mono tracking-wider font-extrabold uppercase px-3.5 py-1.5 rounded-bl-xl shadow-xs">
                {r.type}
              </div>

              <div className="space-y-6 pt-4">
                <div className="h-12 w-12 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-xs border border-slate-200/40 dark:border-slate-700">
                  <FileText className="w-5 h-5" />
                </div>
                
                <div>
                  <h3 className="text-base sm:text-lg font-serif font-semibold text-slate-900 dark:text-white leading-tight">
                    {r.title}
                  </h3>
                  <p className="text-slate-500 dark:text-slate-400 text-xs mt-3 leading-relaxed font-sans font-light">
                    {r.description}
                  </p>
                </div>
              </div>
              ...
              {/* Download count & CTA */}
              <div className="mt-8 pt-6 border-t border-slate-200/50 dark:border-slate-800/80 flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-slate-900 text-white dark:bg-white dark:text-slate-950 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white text-xs font-semibold px-4 py-2.5 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer"
                >
        ...
        {/* HIGH-CONVERSION NEWSLETTER BOX */}
        <div className="bg-slate-950 text-white rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-2xl border border-slate-800 max-w-4xl mx-auto">
          <div className="absolute top-0 left-0 w-64 h-64 bg-blue-600/10 rounded-full filter blur-3xl"></div>
          
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-7 space-y-3">
              <span className="text-[10px] font-mono text-blue-400 uppercase tracking-widest font-extrabold flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-blue-400" />
                VXTGRID EXECUTIVE DIGEST
              </span>
              <h2 className="text-2xl sm:text-3xl font-serif font-normal text-white tracking-tight leading-tight">
              ...
              <AnimatePresence mode="wait">
                {!isSubscribed ? (
                  ...
                  >
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-slate-900/60 text-white text-xs border border-slate-800 pl-10 pr-4 py-3 rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-hidden"
                      />
                    ...
                    <button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold py-3 px-4 rounded-xl transition-all shadow-md cursor-pointer"
                    >
                  ...
                  <motion.div 
                    ...
                    className="bg-blue-900/40 p-6 rounded-2xl border border-blue-800 text-center space-y-3"
                  >
                    <div className="h-10 w-10 bg-blue-500 rounded-full flex items-center justify-center mx-auto shadow-md">
                      <Check className="w-5 h-5 text-white" />
                    </div>
                    <p className="text-sm font-semibold text-white">Registered Successfully!</p>
                    <p className="text-slate-400 text-[11px] leading-tight flex items-center justify-center gap-1">
